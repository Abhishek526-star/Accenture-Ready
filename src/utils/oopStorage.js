// src/utils/oopStorage.js
/**
 * LocalStorage management for OOP Assessment Module
 */

const STORAGE_KEYS = {
  ATTEMPTS: 'accenture_oop_attempts_v1',
  BOOKMARKS: 'accenture_oop_bookmarks_v1',
  STATS: 'accenture_oop_stats_v1'
};

export const oopStorage = {
  getAttempts() {
    try {
      const data = localStorage.getItem(STORAGE_KEYS.ATTEMPTS);
      return data ? JSON.parse(data) : [];
    } catch (e) {
      console.error('Error reading OOP attempts:', e);
      return [];
    }
  },
  ...
  saveAttempt(attempt) {
    try {
      ...
      console.error('Error saving OOP attempt:', e);
      return null;
    }
  },
  ...
  getBookmarks() {
    try {
      ...
      console.error('Error reading OOP bookmarks:', e);
      return [];
    }
  },
  ...
  toggleBookmark(questionId) {
    try {
      ...
      console.error('Error toggling OOP bookmark:', e);
      return [];
    }
  },
  ...
  getStats() {
    try {
      ...
      console.error('Error reading OOP stats:', e);
  ...
  updateOverallStats(newAttempt) {
    try {
      ...
      console.error('Error updating OOP stats:', e);
    }
  }
};
