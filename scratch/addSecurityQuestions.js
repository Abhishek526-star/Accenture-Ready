// scratch/addSecurityQuestions.js
import fs from 'fs';
import path from 'path';
import { fileURLToPath } from 'url';

const __dirname = path.dirname(fileURLToPath(import.meta.url));
const targetFile = path.join(__dirname, '..', 'src', 'data', 'cloudQuestions.js');
let content = fs.readFileSync(targetFile, 'utf8');

// Security Questions List (45 MCQs)
const securityQuestions = [
  ...
  // ==========================================
  {
    ...
    correctAnswer: 'B',
    explanation: 'Cloud Security protects cloud-based data, applications, identities, networks, and infrastructure against unauthorized access, attacks, data loss, and threats. Storage capacity and CPU are scalability/performance concerns.',
  ...
  },
  {
    ...
    correctAnswer: 'C',
    explanation: 'Confidentiality ensures that sensitive data is accessible only to authorized entities and kept private from unauthorized viewing or disclosure.',
  ...
  },
  {
    ...
    correctAnswer: 'B',
    explanation: 'Integrity guarantees that data remains accurate, complete, and protected against unauthorized modification or tampering.',
  ...
  },
  {
    ...
    correctAnswer: 'C',
    explanation: 'Availability ensures that authorized users have timely and reliable access to applications and data. Denial of Service directly targets Availability.',
  ...
  },
  {
    ...
    tier: 'sec-1',
    tierName: 'Security Tier 1 — Core Cyber & CIA',
    topic: 'Threats, Vulnerabilities & Misconfiguration',
    ...
    correctAnswer: 'C',
    explanation: 'A vulnerability is an internal security flaw or weakness in a system (such as weak passwords, unpatched software, or open ports) that can be exploited by threats.',
  ...
  },
  {
    ...
    correctAnswer: 'D',
    explanation: 'A threat is any external actor, malware, or event capable of causing harm or exploiting vulnerabilities. Weak passwords and unpatched servers are vulnerabilities.',
  ...
  },
  {
    ...
    tier: 'sec-1',
    tierName: 'Security Tier 1 — Core Cyber & CIA',
    topic: 'Security Controls (Preventive/Detective/Corrective)',
    ...
    correctAnswer: 'B',
    explanation: 'The Principle of Least Privilege (PoLP) dictates granting users, applications, and services only the minimum permissions necessary to complete their job duties.',
  ...
  },
  {
    ...
    correctAnswer: 'B',
    explanation: 'Defense in Depth implements layered security controls (WAF → Firewall → MFA → IAM → Encryption → Monitoring) so that if one security layer fails, subsequent layers prevent compromise.',
  ...
  },
  {
    ...
    correctAnswer: 'B',
    explanation: 'Preventive controls actively stop attacks or security incidents before they occur. A firewall blocks unauthorized network packets at the perimeter.',
  ...
  },
  {
    ...
    correctAnswer: 'C',
    explanation: 'Detective controls identify, log, and alert on suspicious activity, attacks, or policy violations during or after they occur (e.g. SIEM, IDS, telemetry monitoring).',
  ...
  },
  {
    ...
    difficulty: 'Easy',
    question: 'Which is an example of a corrective security control?',
    options: [
      { id: 'A', text: 'Firewall' },
      { id: 'B', text: 'MFA' },
    ...
    correctAnswer: 'C',
    explanation: 'Corrective controls repair, restore, or recover systems and data back to their normal operational state after an incident has occurred (e.g. backup restoration, disaster recovery plans).',
  ...
  },
  {
    ...
    correctAnswer: 'B',
    explanation: 'Cloud misconfiguration occurs when cloud resources are improperly set up by the customer (such as public S3 buckets or open 0.0.0.0/0 database ports). It is the #1 cause of cloud data breaches.',
    memoryTip: 'Cloud misconfiguration is the leading cause of cloud data leaks'
  },
  {
    id: 'sec1-q13',
    tier: 'sec-1',
    ...
    correctAnswer: 'A',
    explanation: 'Encryption transforms human-readable plaintext into unreadable ciphertext using cryptographic keys, ensuring Confidentiality even if the storage or network is intercepted.',
  ...
  },
  {
    ...
    correctAnswer: 'B',
    explanation: 'Encryption is a two-way reversible cryptographic process that encodes plaintext into ciphertext using a key, and can be decrypted back using the appropriate key.',
  ...
  },
  {
    ...
    correctAnswer: 'A',
    explanation: 'Cryptographic hashing is a one-way mathematical transformation that produces a fixed-size digest. Unlike encryption, hashing is deliberately irreversible and is used to verify data Integrity.',
  ...
  },
  {
    ...
    tier: 'sec-1',
    tierName: 'Security Tier 1 — Core Cyber & CIA',
    topic: 'Zero Trust & Identity (IAM, MFA, RBAC)',
    ...
    correctAnswer: 'B',
    explanation: 'Authentication (AuthN) verifies the identity of a user or system ("Who are you?"). Authorization (AuthZ) verifies permissions ("What are you allowed to do?").',
  ...
  },
  {
    ...
    correctAnswer: 'C',
    explanation: 'MFA requires two or more distinct factor categories: Something you know (Password/PIN) + Something you have (Smartphone/OTP) or Something you are (Biometrics).',
  ...
  // ==========================================
  {
    ...
    correctAnswer: 'B',
    explanation: 'A firewall monitors and filters incoming and outgoing network packets based on configured rules (IP addresses, port numbers, protocols).',
  ...
  },
  {
    ...
    tier: 'sec-2',
    tierName: 'Security Tier 2 — Network, Zero Trust & RBAC',
    topic: 'Security Logging & Disaster Recovery',
  ...
  },
  {
    ...
    tier: 'sec-2',
    tierName: 'Security Tier 2 — Network, Zero Trust & RBAC',
    topic: 'API Security & Protocols (HTTPS/TLS)',
...
// Option explanations for Cloud Security questions
const securityOptionExplanations = {
  'sec1-q1': {
...
const securityStudyGuides = [
  {
    tier: 'sec-1',
    title: 'Cloud Security Tier 1: Core Cybersecurity & CIA Triad',
    sections: [
      {
        heading: 'What is Cloud Security?',
        content: `Cloud Security is the set of policies, technologies, controls, and practices used to protect cloud-based data, applications, identities, networks, and infrastructure from unauthorized access, attacks, and data loss.

**Main Security Goals:**
* Prevent unauthorized access & data theft.
* Prevent data modification (maintain integrity).
* Maintain continuous service availability.
* Detect suspicious attacks and recover from incidents.`
      },
      {
      ...
      },
      {
        ...
        content: `* **Threat:** Actor or event capable of causing harm (Hacker, Malware, DDoS botnet).
* **Vulnerability:** Internal system flaw or weakness that can be exploited (Weak password, unpatched OS, public S3 bucket).
* **Risk:** Potential loss resulting from a threat exploiting a vulnerability (*Risk = Threat × Vulnerability × Impact*).`
      },
      {
...
* **Corrective (Recover after damage):** Backup restoration, Disaster recovery plans, automated rollback.`
  ...
  {
    tier: 'sec-2',
    title: 'Cloud Security Tier 2: Network Security, Zero Trust & RBAC',
    sections: [
      {
...
// Read existing cloudQuestions
import { cloudQuestions, CLOUD_TIERS, CLOUD_TOPICS, cloudStudyGuides, optionExplanationsMap } from '../src/data/cloudQuestions.js';

// Combine
const combinedQuestions = [...cloudQuestions, ...securityQuestions];
const combinedOptionExplanations = { ...optionExplanationsMap, ...securityOptionExplanations };
const combinedStudyGuides = [...cloudStudyGuides, ...securityStudyGuides];
...
const updatedTiers = [
  ...
  {
    id: 'sec-1',
    title: 'Security Tier 1 — Core Cyber & CIA',
    badge: '20 Questions',
    description: 'CIA Triad, Security Controls, Threat vs Vulnerability, Misconfigurations, and Cyber Principles.'
  },
  {
    id: 'sec-2',
    title: 'Security Tier 2 — Network, Zero Trust & RBAC',
    badge: '25 Questions',
    description: 'Firewalls, Security Groups vs NACLs, 3-Tier Segmentation, VPN, Zero Trust, MFA, RBAC, and TLS.'
  }
];

// Update Topics
const newTopicIds = new Set(CLOUD_TOPICS.map(t => t.id));
const securityTopicsToAdd = [
  'Cloud Security Fundamentals',
  'CIA Triad',
  'Security Controls (Preventive/Detective/Corrective)',
  'Threats, Vulnerabilities & Misconfiguration',
  'Network Security & Firewalls',
  'Security Groups vs NACLs',
  'Zero Trust & Identity (IAM, MFA, RBAC)',
  'Encryption & Data Security',
  'API Security & Protocols (HTTPS/TLS)',
  'Security Logging & Disaster Recovery'
];

const updatedTopics = [...CLOUD_TOPICS];
securityTopicsToAdd.forEach(t => {
  if (!newTopicIds.has(t)) {
    updatedTopics.push({ id: t, label: t });
  }
});

// Re-generate file content
const output = `// src/data/cloudQuestions.js
// Comprehensive Cloud Computing & Security Question Bank: 130 Curated MCQs across 5 Tiers

export const CLOUD_TIERS = ${JSON.stringify(updatedTiers, null, 2)};

export const CLOUD_TOPICS = ${JSON.stringify(updatedTopics, null, 2)};

export const cloudQuestions = ${JSON.stringify(combinedQuestions, null, 2)};

export const cloudStudyGuides = ${JSON.stringify(combinedStudyGuides, null, 2)};

export const optionExplanationsMap = ${JSON.stringify(combinedOptionExplanations, null, 2)};
...
export function getQuestionsByTier(tier) {
  ...
  return cloudQuestions.filter((q) => String(q.tier) === String(tier));
}
...
console.log('Successfully updated cloudQuestions.js! Total questions:', combinedQuestions.length);
